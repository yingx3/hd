...
function [Phead,ZMAX,Fs]=trigrs_wet1(T,file_path,dem,slope,flowdirection,zmax,depthwt,Ys,Yw,c,f,Ks,Izlt,D0)
w1=dem.size(1);
w2=dem.size(2);
Dem=double(dem.Z);
...
Fs=reshape(FS,w1,w2);
dem.Z=Phead;
GRIDobj2geotiff(dem,'C:\Users\87856\Desktop\TRIGRSshuicheng\TRIGRSshuicheng\results\wet1_Phead');% storage_positionof result_please revise it
dem.Z=Fs;
GRIDobj2geotiff(dem,'C:\Users\87856\Desktop\TRIGRSshuicheng\TRIGRSshuicheng\results\wet1_Fs');% storage_positionof result_please revise it
dem.Z=ZMAX;
GRIDobj2geotiff(dem,'C:\Users\87856\Desktop\TRIGRSshuicheng\TRIGRSshuicheng\results\wet1_ZMAX11');% storage_positionof result_please revise it
